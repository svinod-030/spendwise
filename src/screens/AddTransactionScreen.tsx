...
const AddTransactionScreen = ({ navigation, route }: any) => {
  ...
  const editingTransaction = route?.params?.editingTransaction as Transaction ?? null;
  ...
  }, [fetchCategories, editingTransaction]);
  ...
  return (
    <View className="flex-1 bg-white dark:bg-slate-950" style={{ paddingTop: insets.top }}>
      ...
      >
        ...
        <View className="p-6 bg-white/80 dark:bg-slate-950/80 border-t border-slate-50 dark:border-slate-900" style={{ paddingBottom: insets.bottom + 20 }}>
          <TouchableOpacity
            onPress={handleSave}
            disabled={!canSave}
            activeOpacity={0.8}
